"""Starlette ASGI application factory for nanobot web API.
...
from nanobot.api.auth import TokenAuthMiddleware
from nanobot.api.routes_api import build_api_routes
from nanobot.api.routes_chat import chat_ws_endpoint
...
def create_app(
    ...
    # web/ lives at the repo root, two levels above this file (nanobot/api/app.py)
