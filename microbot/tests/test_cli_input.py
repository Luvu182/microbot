...
from microbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("microbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("microbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("microbot.cli.commands.PromptSession") as MockSession, \
         patch("microbot.cli.commands.FileHistory") as MockHistory, \
